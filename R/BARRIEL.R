BARRIEL <-
function(inputFile=NA,align=NA,saveFile=TRUE,outnameDist=paste(inputFile,"IndelDistanceBarriel.txt",sep="_"),outnameCode=paste(inputFile,"Barriel_coding.txt",sep="_"),addExtremes=FALSE)
{
#require(ape)
